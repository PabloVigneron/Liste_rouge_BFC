...
# especes_lrr_2014 <- data.frame(especes_lrr_2014) %>%
#   rename(esp_code_alternatif = especes_lrr_2014)
# 
# traits_biologiques <- traits_biologiques %>%
#   left_join(especes_lrr_2014, by = "esp_code_alternatif")
...
#   mutate(tyl_libelle = as.factor(tyl_libelle))
# 
# 
