...
n_mini_annee <- 1 # (9)Nombre minimum d'années des séries de pêches 

n_max_manquant <- 20 # (2)Nombre d'années manquantes maximum consécutives sur les séries de pêches 
