...
```{r}
mes_especes <- c("ABL", "ANG", "BAF", "BLN", "BRB", "BRE", "BRO", "CCO", "CHA", "CHE", "EPI", "EPT", "GAR", "GOU" ,"HOT" ,"LOF" ,"LOR", "LOT", "LPP", "OBR", "PER" ,"ROT", "SPI", "TAN", "TOX", "TRF", "VAI", "VAN")
```
...
statut_pourcentage_evo <- df_zip_glmm_resultats %>%
...
```{r}
liste_rouge_prelim <- table_liste_bfc_sp_cor %>% 
...
flextable::flextable() %>%
  ...
  flextable::set_caption("Liste rouge régionale des populations de poissons d'eau douce de BFC")
