---
title: "02_production_carte_selection_ope"
...
# Objectif : Dynamique de population des poissons d'eau douce de Bourgogne-Franche-Comté
...
carte_france_dept <- ggplot(data = france) + # Création de la zone précise de l'étude (#BFC)
