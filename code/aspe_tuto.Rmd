...
Le présent document vise à présenter comment importer les tables de la base ASPE sous la forme de `dataframe` R. Il est accompagné d'autres tutos sur l'utilisation des tables, rassemblés sur le dépôt <https://rpubs.com/kamoke>.
...
> À la racine on trouve le fichier projet `.Rproj`, sur lequel il convient de cliquer à chaque fois qu'on veut ouvrir une session de ce projet.
