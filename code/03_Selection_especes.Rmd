...
mes_especes <- c("ABL", "ANG", "ASP", "BAF", "BBG", "BLE", "BLN", "BOU", "BRB", "BRE", "BRO", "CAA", "CAG",  "CAS", "CCO", "CDR", "CHA", "CHE",  "EPI", "EPT","GAR", "GDL", "GOO", "GOU", "GRE", "GTN", "HOT","LOF", "LOR", "LOT", "LPM", "LPP",  "OBR", "PCH", "PER", "PES", "PSR",  "ROT", "SAN", "SAT", "SIL", "SPI", "TAC", "TAN", "TOX", "TRF", "VAI", "VAN", "VAR")
```
